...
while selection2 != 'n':
    user2Bills[index] = str(input("What is the name of the bill that you are about to enter?")) # stores each bill name in array to display later
    user2Input[index] = str(input("How much did " + user2Name + " pay for " + user2Bills[index] + " this month?")) # stores user input in an array, starting at 0
